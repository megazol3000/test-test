    ...
    var _loop2 = function _loop2(_i2) {
        if (navListItems[_i2].classList.contains('test-list__item_active')) {
            ...
            completeTest.addEventListener('click', function () {
                ...
                for (var j = 0; j < tests[_i2].questions.length; j++) {
                    if (tests[_i2].questions[j][7] == tests[_i2].questions[j][8]) {
                        counterAns += 1;
                    }
                }
                ...
                for (var _j = 0; _j < tests[_i2].questions.length; _j++) {
                    testForm.innerHTML += '\n                        <div class="screen-result-item">\n                        <p class="form-question">' + tests[_i2].questions[_j][0] + '</p>\n                                <span>\u041F\u0440\u0430\u0432\u0438\u043B\u044C\u043D\u044B\u0439 \u043E\u0442\u0432\u0435\u0442: ' + tests[_i2].questions[_j][7] + '</span>\n                                <span>\u0412\u044B \u043E\u0442\u0432\u0435\u0442\u0438\u043B\u0438: ' + tests[_i2].questions[_j][8] + '</span>\n                        </div>\n                        ';
                }
